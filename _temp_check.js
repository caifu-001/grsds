...
function switchTab(tab){
  ...
  if(tab==='projects'){
    var pjv=document.getElementById('projects-view');pjv.classList.remove('hidden');pjv.style.display='';pjv.style.visibility='visible';
...
function openProjectFormFromLead(leadId,projectName,companyName,clientId){
  ...
  document.getElementById('pf-notes').value='';
  // If clientId provided and allClients loaded, auto-fill
  if(clientId&&allClients&&allClients.length){
    var client=allClients.find(function(c){return c.id===clientId});
    if(client){
      document.getElementById('pf-company-name').value=client.name||'';
      ...
      if(contacts.length){
        document.getElementById('pf-contact-name').value=contacts[0].name||'';
        document.getElementById('pf-contact-title').value=contacts[0].title||'';
        document.getElementById('pf-contact-phone').value=contacts[0].phone||'';
      }
    }
  }
  ...
  document.getElementById('opp-form-overlay').classList.remove('hidden');
}
